...
<div class="shell">
	...
	<div id="main">
		...
		<div class="cl">&nbsp;</div>
		<% List<Item> pList = (List<Item>)request.getAttribute("product");%>
			<div >	
            <% if( pList != null)
                { 
            	for(int i =0; i< pList.size();i++)
                	...
                	{  %> 
                		<h2>             	                    
                        <%out.print("JSP log"+pList.get(i).item_name); %></a>
                        </h2> 
                        ...
                        <h4>Product ID: <%out.print(pList.get(i).item_id); %></h4>
                        <h4>Category : <strong><%out.print(pList.get(i).item_category); %></h4>
                        <h4>Brand : <%out.print(pList.get(i).item_brand); %></h4>
                        <h4>Shipping : <%out.print(pList.get(i).item_shipping); %></h4>
                        <h4>Size : <%out.print(pList.get(i).item_size); %></h4>
                        <p>Description : <%out.print(pList.get(i).item_description); %>  </p>
                        <p>Dimension : <%out.print(pList.get(i).item_dimensions); %>  </p>
